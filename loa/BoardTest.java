...
public class BoardTest {
    ...
    public void testMajDiaCount() {
        ...
        Board b = new Board();
        int[][] majDiaCount = new int[][] { { 0, 2, 2, 2, 2, 2, 2, 0 },
            { 2, 0, 2, 2, 2, 2, 2, 2 },
            { 2, 2, 0, 2, 2, 2, 2, 2 },
            { 2, 2, 2, 0, 2, 2, 2, 2 },
            { 2, 2, 2, 2, 0, 2, 2, 2 },
        ...
        c.set(7, 4, BP);
        c.set(8, 7, EMP);
        int[][] majDiaCount2 = new int[][] { { 1, 1, 3, 2, 2, 2, 2, 0 },
            { 2, 1, 1, 3, 2, 2, 2, 2 },
            { 1, 2, 1, 1, 3, 2, 2, 2 },
            { 3, 1, 2, 1, 1, 3, 2, 2 },
            { 2, 3, 1, 2, 1, 1, 3, 2 },
    ...
    public void testMinDiaCount() {
        ...
        Board b = new Board();
        int[][] minDiaCount = new int[][] { { 0, 2, 2, 2, 2, 2, 2, 0 },
            { 2, 2, 2, 2, 2, 2, 0, 2 },
            { 2, 2, 2, 2, 2, 0, 2, 2 },
            { 2, 2, 2, 2, 0, 2, 2, 2 },
            { 2, 2, 2, 0, 2, 2, 2, 2 },
        ...
        c.set(7, 4, BP);
        c.set(8, 7, EMP);
        int[][] minDiaCount2 = new int[][] { { 0, 2, 3, 1, 2, 2, 3, 1 },
            { 2, 3, 1, 2, 2, 3, 1, 2 },
            { 3, 1, 2, 2, 3, 1, 2, 3 },
            { 1, 2, 2, 3, 1, 2, 3, 2 },
            { 2, 2, 3, 1, 2, 3, 2, 2 },
    ...
    public void testPieceCountAlong() {
        ...
        Piece[][] p = { { WP, BP, BP, BP, WP, BP, BP, WP },
            { WP, EMP, EMP, EMP, WP, EMP, EMP, WP },
